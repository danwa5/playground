...
RSpec.describe DatabaseService do
  ...
  describe '#create_records' do
    ...
    context 'when box score data is present' do
      ...
      context 'and players game logs do not exist in database' do
        let(:query_results_1) { double(items: [{ 'game_date' => '2022-10-17', 'cumulative_fg3a' => 10, 'cumulative_fg3m' => 5, 'games_played' => 1 }]) }
        let(:query_results_2) { double(items: [{ 'game_date' => '2022-10-17', 'cumulative_fg3a' => 2, 'cumulative_fg3m' => 1, 'games_played' => 1 }]) }
        let(:query_results_3) { double(items: [{ 'game_date' => '2022-10-17', 'cumulative_fg3a' => 0, 'cumulative_fg3m' => 0, 'games_played' => 0 }]) }
